              ...
              <div className="p-6 space-y-4"> 
                <div className="flex items-start justify-between">
                  ...
                  <ArrowUpRight
                    ...
                    group-hover:translate-x-1 group-translate-y-1 transition-all"
                  />
                </div>
                ...
                <div className="flex flex-wrap gap-2">
                  ...
                  <span key={tagIdx} 
                    className="px-4 py-1.5 rounded-full bg-surface text-sm text-muted-foreground font-medium border border-border/50 hover:border-primary/50 hover:text-primary transition-all duration-300"
                  >
                    {tag}
                  </span>
                ))}
