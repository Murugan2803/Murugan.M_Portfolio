        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8">
            ...
            <div className="flex flex-wrap gap-4 animate-fade-in animation-delay-300">
              ...
              <a href="/Murugan_CV.pdf" download>
            ...
            <div className="flex items-center gap-4 animate-fade-in aimation-delay-400">
              ...
              {[
                { icon: Github, href: "https://github.com/Murugan2803"},
                { icon: Linkedin, href: "https://www.linkedin.com/in/murugan-m0306/"},
              ].map((social, idx) => (
                <a
                  key={idx}
                  href={social.href}
          ...
          <div className="relative animate-fade-in animation-delay-300">
            <div className="relative max-w-sm mx-auto"> 
              <div
                ...
                rounded-3xl bg-gradient-to-br from-primary/30 
              ...
              <div className="relative glass rounded-3xl p-2 glow-border">
                ...
                <div className="absolute -bottom-4 -right-4 glass rounded-xl px-4 py-3 animate-float">
                  <div className="flex items-center gap-3">
                    ...
                    <span className="text-sm fond-medium ">Avilable for Work</span>
                  </div>
                </div>
                {/* Status Badge */}
